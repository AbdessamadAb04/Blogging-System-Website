...
export default function LatestBlogs({ posts, loading }: { posts?: Post[]; loading?: boolean }) {
    ...
    return (
      <section id="latest" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <Headings
            upheading="Fresh Content"
            mainHeading="Latest Travel Stories"
            highlightWords={['Latest']}
            subheading="Stay updated with our newest adventures and travel insights"
          />
        </div>
