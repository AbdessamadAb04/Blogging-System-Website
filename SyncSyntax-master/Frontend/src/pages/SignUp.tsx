        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <div className="mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#333333] mb-2">Join Us</h2>
              <p className="text-gray-600">Create your account and explore new insights</p>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="h-4 w-4 text-[#0077B6] focus:ring-[#0077B6] border-gray-300 rounded mt-1"
                  />
                  <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-700">
                    I agree to the{' '}
                    <Link to="/terms" className="text-[#0077B6] hover:text-[#005f8f] transition-colors">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link to="/privacy" className="text-[#0077B6] hover:text-[#005f8f] transition-colors">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
